...
bool BaseGame::initLoop() {
	...
	warning("CURSOR: initLoop delta X %d: from %d to %d", _mousePos.x - oldX, oldX, _mousePos.x);
...
bool BaseGame::scSetProperty(const char *name, ScValue *value) {
	...
	//////////////////////////////////////////////////////////////////////////
		...
		warning("CURSOR: scSetProperty delta X %d: from %d to %d", _mousePos.x - oldX, oldX, _mousePos.x);
